...
class Grid{
	...
	private function get_between_search($field, $url) {
		...
		//$return['start'] = array('id'=>'search_grid_'.$url.'_'.$field.'_start', 'name'=>$field.'_start');
		//$return['end'] = array('id'=>'search_grid_'.$url.'_'.$field.'_end', 'name'=>$field.'_end');
                $return['start'] = array('id'=>'search_grid_'.$url.'_'.$field.'_start', 'class'=>'datepicker', 'name'=>'search_grid_'.$url.'_'.$field.'_start');
		$return['end'] = array('id'=>'search_grid_'.$url.'_'.$field.'_end', 'class'=>'datepicker', 'name'=>'search_grid_'.$url.'_'.$field.'_end');
		return $return;
	}
