						...
						foreach($search as $s) {
							...
							//echo '<div class="form_horizontal_plc">';
								...
								elseif($s['ftype'] == 'between') {
									echo '<label class="rows_label" for="'.$s['id'].'">'.$s['label'].'</label>';
									echo '<div class="rows_input select_rows">';
										echo ' Between <input class="input_tgl tanggal" type="text" id="'.$s['source']['start']['id'].'" name="'.$s['source']['start']['id'].'"> and ';									
										echo '<input class="input_tgl tanggal" type="text" id="'.$s['source']['end']['id'].'" name="'.$s['source']['end']['id'].'">';
									echo '</div>';							
								}
